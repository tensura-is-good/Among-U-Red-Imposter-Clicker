...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		*/
		...
		Game.last.displayName='<span style="font-size:65%;letter-spacing:-1px;position:relative;bottom:2px;">Grand Wizard tower</span>';//shrink
